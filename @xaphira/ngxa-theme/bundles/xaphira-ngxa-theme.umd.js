(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@nebular/theme'), require('@nebular/eva-icons'), require('@nebular/security'), require('@angular/router'), require('@angular/service-worker'), require('rxjs/operators'), require('rxjs'), require('@ngx-translate/core'), require('@xaphira/shared'), require('rxjs/add/observable/of')) :
    typeof define === 'function' && define.amd ? define('@xaphira/ngxa-theme', ['exports', '@angular/core', '@angular/common', '@nebular/theme', '@nebular/eva-icons', '@nebular/security', '@angular/router', '@angular/service-worker', 'rxjs/operators', 'rxjs', '@ngx-translate/core', '@xaphira/shared', 'rxjs/add/observable/of'], factory) :
    (global = global || self, factory((global.xaphira = global.xaphira || {}, global.xaphira['ngxa-theme'] = {}), global.ng.core, global.ng.common, global['@nebular/theme'], global['@nebular/eva-icons'], global['@nebular/security'], global.ng.router, global.ng['service-worker'], global.rxjs.operators, global.rxjs, global['@ngx-translate/core'], global.shared));
}(this, (function (exports, core, common, theme, evaIcons, security, router, serviceWorker, operators, rxjs, core$1, shared) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NgxaThemeModule = /** @class */ (function () {
        ...
        function () {
            return (/** @type {?} */ ({
                ...
                providers: __spread(PROVIDERS, theme.NbThemeModule.forRoot({
                    name: 'default',
        ...
        NgxaThemeModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        exports: __spread([common.CommonModule], COMPONENTS, PIPES),
                    },] }
        ];
    ...
    exports.NgxaThemeModule = NgxaThemeModule;
...
//# sourceMappingURL=xaphira-ngxa-theme.umd.js.map
