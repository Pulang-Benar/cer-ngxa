...
@Component({
  selector: 'xa-cer-statistics-device',
  styleUrls: ['./ngxa-cer-statistics-device-page.component.scss'],
  templateUrl: './ngxa-cer-statistics-device-page.component.html',
})
export class NgxaCerStatisticsDevicePageComponent implements OnInit, OnDestroy {
  ...
  private getStatistics(): void {
    this.http.HTTP_AUTH(
      this.api['panic']['statistics-device'],
      null,
      null,
      null,
