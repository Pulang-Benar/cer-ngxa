...
@Component({
  selector: 'xa-cer-statistics-emergency',
  styleUrls: ['./ngxa-cer-statistics-emergency-page.component.scss'],
  templateUrl: './ngxa-cer-statistics-emergency-page.component.html',
})
export class NgxaCerStatisticsEmergencyPageComponent implements OnInit, OnDestroy {
