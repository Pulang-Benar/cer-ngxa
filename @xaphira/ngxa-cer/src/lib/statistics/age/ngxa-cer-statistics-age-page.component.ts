...
@Component({
  selector: 'xa-cer-statistics-age',
  styleUrls: ['./ngxa-cer-statistics-age-page.component.scss'],
  templateUrl: './ngxa-cer-statistics-age-page.component.html',
})
export class NgxaCerStatisticsAgePageComponent implements OnInit, OnDestroy {
